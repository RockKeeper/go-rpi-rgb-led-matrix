...
/*
#cgo CFLAGS: -std=c99 -I${PROJECT_DIR}/lib/rpi-rgb-led-matrix/include -DSHOW_REFRESH_RATE
#cgo LDFLAGS: -lrgbmatrix -L${PROJECT_DIR}/lib/rpi-rgb-led-matrix/lib -lstdc++ -lm
